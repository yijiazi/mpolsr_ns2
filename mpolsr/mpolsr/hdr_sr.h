...
struct mojette {
	...
	//int count_;
	int n_;	//the number of the packets which are splitted into
	int m_;	//the number of the packets needed to reconstruct the original packet
...
public:
	...
	//for mojette
	inline int &seq_no(){return sr_mojette_.seqno_;}
	inline int &m_(){return sr_mojette_.m_;}
	inline int &n_(){return sr_mojette_.n_;}

	//dest
	inline int &dest_node(){return dest_;}
